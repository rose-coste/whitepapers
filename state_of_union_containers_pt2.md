...
*A Collection of Design & Development Principles and Technical Specifics of Ecosystem Tools*
...
optimization of the overall size of images(3).
...
-- Be careful with using ENTRYPOINT; it will make it more difficult to
   ...
   confuse users that expect to be able to use the idiom (5).
...
1. <https://docs.docker.com/articles/dockerfile_best-­practices/#run-­only-­one-­
...
4. <https://docs.docker.com/articles/dockerfile_best-­‐practices/#build-­cache>
...
9. <http://www.slideshare.net/timothysc/apache-­coneu>

10. <https://github.com/GoogleCloudPlatform/kubernetes/blob/master/docs/services.md#how-­do-­they-­work>

11. <https://github.com/GoogleCloudPlatform/kubernetes/blob/master/docs/design/networking.md>

12. <https://github.com/GoogleCloudPlatform/kubernetes/blob/master/docs/networking.md>
